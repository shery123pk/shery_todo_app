 ...
 * Beautiful modal for creating new tasks
...
import type { TaskCreate, PriorityLevel } from '@/types/task'
import { X, Plus, Loader2, Tag, FolderOpen } from 'lucide-react'
        ...
        <div className="sticky top-0 bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4 rounded-t-3xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm">Add a task to stay organized</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              autoFocus
              className={`w-full px-4 py-3 border-2 rounded-xl bg-white/50 backdrop-blur-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent ${
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent hover:border-gray-300 resize-none"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent hover:border-gray-300"
            />
          </div>
